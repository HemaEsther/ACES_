...
const Testimonial = () => {
  return (
    <>
      {/* <p className="text-slate-400 font-semibold bg-white dark:bg-black  text-3xl flex justify-center items-center ">Testimonials</p> */}
        ...
        >
          {[...testimonials, ...testimonials].map((testimonial, index) => (
            ...
            >
              ...
              />
              <p className="text-gray-600 dark:text-slate-200 mb-4">{testimonial.text}</p>
